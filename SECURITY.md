...
page on the [documentation website](https://docs.asterisk.org) as it applies to libss7 as well, then use the
"Report a vulnerability" button under the
["Security"](https://github.com/asterisk/libss7/security)
